...
class PlayedToResolver(Plugin, UrlResolver, PluginSettings):
    ...
    def valid_url(self, url, host):
        return re.match('http://(www.)?played.to/([0-9a-z\.-]+)', url, re.IGNORECASE) or self.name in host